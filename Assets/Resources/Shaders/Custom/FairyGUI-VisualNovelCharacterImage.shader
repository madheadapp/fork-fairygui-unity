...
Shader "FairyGUI/VisualNovelCharacterImage"
{
    Properties
    {
        ...
        Pass
        {
            CGPROGRAM
                ...
                struct appdata_t
                {
                    ...
                    float4 texcoordOriginal : TEXCOORD3;
                ...
                v2f vert (appdata_t v)
                {
                    ...
                    o.texcoordOriginal = v.texcoordOriginal;
                ...
                fixed4 frag (v2f i) : SV_Target
                {
                    ...
                    {
                        fixed4 alphaCol = tex2D(_MainTex, i.texcoordAlpha.xy / i.texcoordAlpha.w);
                    ...
                    if(_FadeLeft)
                        alphaMultiplier *= smoothstep( _FadeSize - _FadeSmoothStepRatio,  _FadeSize, i.texcoordOriginal.x );
                    else
                        alphaMultiplier *= smoothstep(0, _EdgeSmoothStepRatio * i.vertex.w, i.texcoordOriginal.x );
                    
                    if(_FadeRight)
                        alphaMultiplier *= 1 - smoothstep( 1 - _FadeSize - _FadeSmoothStepRatio, 1 - _FadeSize, i.texcoordOriginal.x );
                    else
                        alphaMultiplier *= 1 - smoothstep( 1 - _EdgeSmoothStepRatio, i.vertex.w, i.texcoordOriginal.x );
