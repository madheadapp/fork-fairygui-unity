Shader "FairyGUI/DissolveEffect"
{
	 Properties
    {
        _MainTex ("Base (RGB), Alpha (A)", 2D) = "black" {}

        _NoiseTex ("NosieTexture", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata_t v)
            {
                ...
                o.noiseTexCoord = TRANSFORM_TEX(v.noiseTexCoord, _NoiseTex);
				#ifdef PIXELSNAP_ON
            ...
            {
				float cutout = tex2D(_NoiseTex, i.noiseTexCoord).r;
