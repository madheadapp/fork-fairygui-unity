        ...
        Pass
        {
            CGPROGRAM
                ...
                fixed4 frag (v2f i) : SV_Target
                {
                    ...
                    float x = sin( _CustomTime *  _PrimaryFrequency + i.vertexLocal.x / _PrimaryDirectionX + i.vertexLocal.y / _PrimaryDirectionY) * _PrimaryWaveLength - _PrimaryLightLocation;
					fixed3 shineOffset = _WaveColor.rgb * clamp(x, 0, 1);
