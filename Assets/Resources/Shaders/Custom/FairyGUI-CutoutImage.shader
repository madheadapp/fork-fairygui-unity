...
Shader "FairyGUI/CutoutImage"
{
    Properties
    {
        ...
        _Threshold("Cutout threshold", Range(0,1)) = 0.419
        _Softness("Cutout softness", Range(0,0.5)) = 0.5
        _CutoutColor("Cutout color", Color) = (0, 1, 0, 0)
    }
        ...
        Pass
        {
            CGPROGRAM
                ...
                fixed4 frag (v2f i) : SV_Target
                {
                    ...
                    float value = length(fixed3(col.rgb) - _CutoutColor);  
                    col.a = smoothstep(_Threshold, _Threshold + _Softness, value);
