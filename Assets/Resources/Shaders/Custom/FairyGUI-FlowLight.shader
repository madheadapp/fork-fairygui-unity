Shader "FairyGUI/FlowLightImage"
{
     Properties
    {
	    ...
	    _NoiseWeightingEmission("Noise Weighting & Emission", Vector) = (0.5,0.5,1,0)
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _NoiseWeightingEmission;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 noiseUV = i.texcoord.xy * _NoiseTex_ST.xy + _NoiseTex_ST.zw; 
                float4 noise = tex2D(_NoiseTex, noiseUV + _Time.y * _NoiseSpeed.xy );
                float4 noise2 = tex2D(_NoiseTex, noiseUV + _Time.y * _NoiseSpeed.zw );
                col.rgb *= (noise.rgb * _NoiseWeightingEmission.x + noise2.rgb * _NoiseWeightingEmission.y); 
                col.rgb *= _NoiseWeightingEmission.z;
                return col ; 
            }
            ENDCG
        }
