...
Shader "FairyGUI/PerspectiveCardImage"
{
    Properties
    {
        ...
        Pass
        {
            CGPROGRAM
                ...
                v2f vert (appdata_t v)
                {
                    ...
                    worldVertexPos.xyz -= _WorldSpaceCameraPos.xyz;
                    worldVertexPos = float4( 0.0f, worldVertexPos.z * - 0.00001 * (v.vertex.y + 60) , 0.0f, 0.0f );
                    o.vertex += mul(unity_WorldToObject, worldVertexPos);
